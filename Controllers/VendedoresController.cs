...
namespace Tripper.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CPF")] Vendedores vendedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CPF")] Vendedores vendedores)
        {
            if (id != vendedores.Id)
            {
                return NotFound();
