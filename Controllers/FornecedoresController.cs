...
namespace Tripper.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RazaoSocial,CNPJ")] Fornecedores fornecedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RazaoSocial,CNPJ")] Fornecedores fornecedores)
        {
